...
const EventCardComponent = ({ event }: { event: EventCard }) => {
  ...
  const handlePress = () => {
    ...
    router.push(`/(tabs)/forum/forum-page?id=${event.post_id}`);
  };
...
const eventsData:EventCard[] = require('../../public/DonsHack.posts.json');
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.titleContainer}>
        <ThemedText type="title">The Chatroom</ThemedText>
      </ThemedView>
      <ThemedText type="subtitle">Rule 1. We don't talk about the chatroom.</ThemedText>
